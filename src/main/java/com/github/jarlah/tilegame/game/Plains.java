...
import com.github.jarlah.tilegame.files.TileCreator;
...
public class Plains extends Screen {
	...
	private final Level level = new Level("Levels/Plains.csv",
			new TileCreator() {
				public Class<? extends Tile> createTile(int letter) {
					char c = (char) letter;
					switch (c) {
					case 'C':
	...
	public void render(Graphics g) {
		...
		for (int x = cameraInfo.cameraX; x < cameraInfo.cameraWidth
				+ cameraInfo.cameraX; x++) {
			for (int y = cameraInfo.cameraY; y < cameraInfo.cameraHeight
					+ cameraInfo.cameraY; y++) {
